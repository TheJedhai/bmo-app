...
class BmoApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return MaterialApp.router(
      ...
      // listener de lifecycle único para SSE + WebSocket (AppLifecycleReconnect)
      // e o de deep link bmo:// (DeepLinkHandler).
      builder: (context, child) => AppLifecycleReconnect(
        child: DeepLinkHandler(child: child ?? const SizedBox.shrink()),
      ),
