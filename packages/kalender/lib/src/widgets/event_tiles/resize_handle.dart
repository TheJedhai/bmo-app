...
class _ResizeHandleWidgetState extends State<ResizeHandleWidget> {
  ...
  void _onEnter(PointerEnterEvent event) {
    ...
    // In imprecise mode, handles are shown only on selection, not hover.
    if (context.interaction.inputMode == InputMode.imprecise) return;
...
class ResizeHandle extends StatelessWidget {
  ...
  /// Optional visual widget override for the resize handle.
  ///
  /// When provided, this widget is used instead of the one from [tileComponents].
  final Widget? visual;
  ...
  Widget build(BuildContext context) {
    ...
    final resizeHandle = visual ?? (isVertical ? tileComponents.verticalResizeHandle : tileComponents.horizontalResizeHandle);
